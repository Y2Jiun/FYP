            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                <h1 className="mb-5 text-3xl leading-tight font-bold text-black sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight dark:text-white">
                  Revolutionizing Property Transparency with Secure Verification
                </h1>
                <p className="text-body-color dark:text-body-color-dark mb-12 text-base leading-relaxed! sm:text-lg md:text-xl">
                  DeveloperShield empowers property transactions through
                  verified documentation, secure verification processes, and
                  transparent property management. Join thousands of users who
                  trust our platform for secure, transparent real estate
                  transactions.
                </p>
